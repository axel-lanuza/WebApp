(function ($) {
    ...
    function _bindingBoolean(target, options, level, name, obj) {
        ...
        var sl = '<div id="' + id + '" style="' + generalMargin(level) + '"><div class="name">' + name + '</div><div class="tag">:</div>';
        sl += '<div class="val-bool">' + obj + '</div><br></div>';
        $(sl).appendTo(target);
    }
    ...
    function _bindingNumber(target, options, level, name, obj) {
        var id = generalId(target[0].id, name, level);
        var sl = '<div id="' + id + '" style="' + generalMargin(level) + '"><div class="name">' + name + '</div><div class="tag">:</div>';
        sl += '<div class="val-num">' + obj + '</div><br></div>';
        $(sl).appendTo(target);
    }
    ...
    function _bindingString(target, options, level, name, obj) {
        ...
        var sl = '<div id="' + id + '" style="' + generalMargin(level) + '"><div class="name">' + name + '</div><div class="tag">:</div>';
        sl += '<div class="val-str">' + val + '</div><br></div>';
        $(sl).appendTo(target);
    }
    ...
    function generalStyle(options) {
        ...
        css += '.name:hover{background-color:lightyellow;}';
        css += '.val-str{float:left;color:' + options.color.string + ';}';
        css += '.val-str:hover{background-color:lightskyblue;}';
        css += '.val-num{float:left;color:' + options.color.num + ';}';
        css += '.val-num:hover{background-color:lightgreen;}';
        css += '.val-bool{float:left;color:' + options.color.bool + ';}';
        css += '.val-bool:hover{background-color:lightblue;}';
